...
export class ParallelCalculator {
    constructor(state) {
        this.state = state;
        this.id = 'parallel';
        this.name = 'Resistencias en Paralelo';
    ...
    render() {
        ...
        subtitle.textContent = '1/Rt = 1/R1 + 1/R2 + 1/R3 + ...';
        ...
        calcBtn.addEventListener('click', () => {
            if (this.resistors.some(r => r === null || r === 0)) {
                notification.error('Todos los valores deben ser válidos y mayores a 0');
                return;
            }
    ...
    calculate() {
        const invSum = this.resistors.reduce((sum, r) => sum + (1 / r), 0);
        const equivalent = 1 / invSum;
        ...
        container.innerHTML = `
            ...
            <div class="alert alert-success mt-4">
                ...
                <div class="alert-content">
                    <div class="alert-title">Cálculo en Paralelo</div>
                    <div class="alert-message">
                        1/Rt = ${result.resistors.map((r, i) => `1/${r.toFixed(2)}`).join(' + ')}<br>
                        Rt = ${result.equivalent.toFixed(2)}Ω
                    </div>
                </div>
            </div>
        `;
